...
## Usage vs archive
- **Subscription expires 2026-07-12** — maximize download before then.
- Having forex/crypto/bulk on disk does **not** require using it in the trading model.
- Archive first; select features later.
